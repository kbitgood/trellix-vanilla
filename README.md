...
I noticed Ryan's Trellix demo was missing some features. I'd give his demo an A- 😉. So I added a couple of things. Most notably the ability to delete columns from a board. (How can you use this without that?) And I also added the ability to reorder columns with drag and drop.
...
- [ ] Make it work with javascript disabled
   - This one is almost there. Try it! I just need a fallback for the drag and drop.
...
## Deploy with Fly
Thank you to Andrea Giammarchi for the [deployment help](https://github.com/WebReflection/fly-bun-sqlite/tree/main)
```
Deploy with fly
